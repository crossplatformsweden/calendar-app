...
export interface IAddedAppointment {
  title: string;
  startDate: Date;
  endDate: Date;
  allDay?: boolean;
...
export const weatherArray: IWeather[] = [
  { day: 1, weather: "Temp 11°/ Vind 1 m/s" },
  { day: 2, weather: "Temp 12°/ Vind 2 m/s" },
  { day: 3, weather: "Temp 13°/ Vind 3 m/s" },
  { day: 4, weather: "Temp 14°/ Vind 4 m/s" },
  { day: 5, weather: "Temp 15°/ Vind 5 m/s" },
];
